...
const MAP: Record<ResourceState, { label: string; cls: string }> = {
  HEALTHY: { label: "정상", cls: "text-ok bg-ok/12" },
  COOLING: { label: "냉각", cls: "text-cool bg-cool/12" },
  RECOVERING: { label: "회복", cls: "text-recover bg-recover/12" },
  BLOCKLISTED: { label: "차단", cls: "text-block bg-block/12" },
};
